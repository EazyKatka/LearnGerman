...
const germanWords = {
    ...
    "Clothing": [
        ...
        { german: "T-Shirt", swedish: "T-shirt" },
        ...
        { german: "Shorts", swedish: "Shorts" },
        { german: "Hoodie", swedish: "Hoodie" },
    ...
    "Transportation": [
        ...
        { german: "Skateboard", swedish: "Skateboard" },
        { german: "Segelboot", swedish: "Segelbåt" },
        { german: "Yacht", swedish: "Yacht" },
        { german: "Rikscha", swedish: "Riksha" },
        { german: "Heißluftballon", swedish: "Luftballong" },
        { german: "Kutsche", swedish: "Kalesch" },
        { german: "Einrad", swedish: "Enhjuling" },
        { german: "Fallschirm", swedish: "Fallschärm" },
        { german: "Jetski", swedish: "Jetski" },
        { german: "Surfbrett", swedish: "Surfbräda" },
        { german: "E-Scooter", swedish: "El-scooter" },
        { german: "Bahn", swedish: "Järnväg" },
        { german: "Fahrradanhänger", swedish: "Cykelvagn" },
        { german: "Gleitflugzeug", swedish: "Glider" },
        { german: "Monorail", swedish: "Monorail" },
    ...
    "Professions": [
        ...
        { german: "Handwerker", swedish: "Handlare" },
    ...
    "Adjectives": [
        ...
        { german: "bekommen", swedish: "få" },
        { german: "verlieren", swedish: "förlora" },
        { german: "erhalten", swedish: "få" },
        { german: "verursachen", swedish: "orsaka" }
    ],
    "Days of the Week": [
    ...
    "Technology": [
        ...
        { german: "Tablet", swedish: "surfplatta" },
        ...
        { german: "Website", swedish: "webbplats" },
        { german: "E-Mail", swedish: "e-post" },
        { german: "Social Media", swedish: "sociala medier" },
        { german: "Streaming", swedish: "strömmande" },
        ...
        { german: "WLAN", swedish: "trådlöst nätverk" },
        { german: "Bluetooth", swedish: "bluetooth" },
        { german: "GPS", swedish: "GPS" },
        { german: "Virtual Reality", swedish: "virtuell verklighet" },
        { german: "Augmented Reality", swedish: "förstärkt verklighet" },
        ...
        { german: "Download", swedish: "nedladdning" },
        { german: "Upload", swedish: "uppladdning" },
        { german: "Browser", swedish: "webbläsare" },
        { german: "Suchmaschine", swedish: "sökmotor" },
        { german: "Link", swedish: "länk" },
        { german: "Cookie", swedish: "cookie" },
        { german: "Virus", swedish: "virus" },
        { german: "Malware", swedish: "skadlig programvara" },
        ...
        { german: "Interface", swedish: "gränssnitt" },
        { german: "Hardware", swedish: "hårdvara" },
        { german: "Software", swedish: "mjukvara" },
        { german: "Betriebssystem", swedish: "operativsystem" },
        { german: "Programmierung", swedish: "programmering" },
